      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-amber-400 mb-4">Charmntreats</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/vlog" className="text-slate-300 hover:text-amber-400 transition-colors">
                  Gallery
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/auth" className="text-slate-300 hover:text-amber-400 transition-colors">
                  Login
                </Link>
              </li>
            </ul>
