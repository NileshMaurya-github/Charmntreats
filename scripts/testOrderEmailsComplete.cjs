// Test complete order email system with invoice details
const BREVO_API_KEY = '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';
const BREVO_API_URL = 'https://api.brevo.com/v3/smtp/email';

// Test order data with complete invoice details
const testOrderData = {
  customerInfo: {
    fullName: 'John Doe',
    email: 'nilesh.maurya.developer@gmail.com', // Use your email for testing
    phone: '9876543210',
  ...
  try {
          ...
          <div style="padding: 30px 20px;">
                    ...
                    <td style="padding: 15px 12px;">
                      <div style="display: flex; align-items: center;">
                        <div>
                          ...
                          <small style="color: #666;">SKU: ${item.catalogNumber}</small>
                        </div>
                      </div>
                    </td>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 30px 0;">
              <div style="background-color: #fff3cd; padding: 20px; border-radius: 8px; border-left: 4px solid #ffc107;">
                ...
                ${paymentMethod === 'cod' ? 
                  '<p style="margin: 5px 0 0 0; font-size: 14px; color: #856404;">Pay ₹' + finalTotal.toLocaleString() + ' when your order arrives</p>' : 
            ...
            <div style="background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); padding: 25px; border-radius: 8px; margin: 30px 0;">
              ...
              <div style="color: #1565c0;">
                ...
                ${paymentMethod === 'cod' ? 
                  '<div style="margin: 10px 0; display: flex; align-items: center;"><span style="background: #ff9800; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-flex; align-items: center; justify-content: center; margin-right: 10px; font-size: 12px; font-weight: bold;">💰</span><span><strong>Keep ₹' + finalTotal.toLocaleString() + ' ready for cash payment</strong></span></div>' : ''
                }
              </div>
            </div>
    ...
    const response = await fetch(BREVO_API_URL, {
      ...
      body: JSON.stringify({
        ...
        subject: `🎉 Order Confirmed #${orderId} - ₹${finalTotal.toLocaleString()} | Charmntreats`,
        htmlContent
      })
    });
...
async function testCompleteEmailSystem() {
  ...
  try {
    console.log('\n1️⃣ Sending detailed customer email with invoice...');
    const customerEmailSent = await sendDetailedCustomerEmail(testOrderData);
    
    console.log('\n⏳ Waiting 2 seconds before sending store email...');
    ...
    if (customerEmailSent && storeEmailSent) {
      ...
      console.log('📧 Check your email inbox for the detailed invoice');
      console.log('📧 Check charmntreats@gmail.com for store notification');
      
      console.log('\n✨ Email Features Included:');
      console.log('• Complete order invoice with itemized breakdown');
      console.log('• Professional HTML design with your branding');
      console.log('• Detailed customer and delivery information');
      console.log('• Payment method and amount clearly displayed');
      console.log('• Next steps and customer support information');
      console.log('• Store notification with all order details');
